...
import com.ruisasi.core.KeyMouseSend;
...
private  KeyMouseSend kms;
    ...
    public EventController(Device device, KeyMouseSend kms) {
        this.device = device;
        this.kms = kms;
        initPointer();
        Log.i("StartActivity","EventController Constructor");
...
public static Boolean obj = new Boolean(false);
    ...
    public void control() throws IOException {
        ...
        while (VideoStreamSend.stopStream) {
                synchronized (obj){
                    try {
                       // Log.i("StartActivity","A Wait start......");
                        obj.wait();
                        if(obj ==true){
                            break;
                        }
                      //  Log.i("StartActivity","A Wait End.....");
    ...
    private void handleEvent() throws IOException {
        Log.i("StartActivity","handleEvent () success");
        ControlEvent controlEvent = kms.receiveControlEvent();
        ...
        switch (controlEvent.getType()) {
            ...
            default:
                // do nothing
                Log.i("StartActivity","handleEvent function 无效事件");
                break;
        }
